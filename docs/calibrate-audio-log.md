# Calibrate Audio: work orders and log of the finished phases

The work orders of the phases already built, and their hand-over log, moved out of
[calibrate-audio-work-orders.md](calibrate-audio-work-orders.md) once they were done.
**Phase agents do not read this file**; the work orders' section 3 says what they need of
it. The documentation phase (D) reads the log, and deletes this file with the work orders.

## Work orders of the finished phases
